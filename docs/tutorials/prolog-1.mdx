...
:::caution
The OKP4 blockchain uses [ichiban/prolog](https://github.com/ichiban/prolog/), a different Prolog interpreter. Natively available predicates differ. [Here](https://github.com/ichiban/prolog/wiki#predicates) is the list of built-in predicates.    
::: 
...
The OKP4 blockchain uses the [ichiban/prolog](https://github.com/ichiban/prolog/) Prolog interpreter. Built-in predicates are listed [here](https://github.com/ichiban/prolog/wiki#predicates). 
