...
Let's check the text is correctly stored on-chain, with an `object_data` of the `objectarium` instance we just created (address = `okp41tca04wdta7pyzzyetgqyl2rn9v5vgxq0cwvdduel8sgw4g64at7q8jja85`, id = `71f9954abebbd23da1664914cd599f8039585fa3d81735b4abe20893abd32213`).
