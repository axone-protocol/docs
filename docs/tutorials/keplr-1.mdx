...
![Axone with Keplr](/img/content/tutorials/keplr-0.webp)
...
1. [**Visit** the official Axone faucet website](https://faucet.okp4.network/).
...
<div style={{ display: "flex", justifyContent: "center" }}><img src="/img/content/tutorials/keplrmaj-8.webp"></img></div>

2. Let's check you received the **AXON** tokens:

- Click on the Keplr extension button
- Look for `Axone drunemeton` in the list or type "okp4" in the "Search for asset or chain" field to see it easily. 
...
<div style={{ display: "flex", justifyContent: "center" }}><img src="/img/content/tutorials/keplr-11.webp"></img></div>
...
<div style={{ display: "flex", justifyContent: "center" }}><img src="/img/content/tutorials/keplrmaj-12.webp"></img></div>
