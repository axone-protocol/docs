...
The **[OKP4 ontology](/academy/resources#ontology-how-its-represented-semantic-description)** is used to describe the dataverse. In the dataverse, resources are identified by their DID. 
