...
Here are the five steps to declare a resource in the Dataverse: 
...
Governance VPs play an essential role in the dataverse, applying universally to various categories of resources, such as datasets, services, and zones (LINK).
