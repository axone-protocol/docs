...
| Paragraph   | 1.1.1.1.1      | Governance can only be amended by the identity `did:key:0x04d1j1x8f8a7a28f9a5a254c326a963a22f5a5b5d5f5e5d5c5b5a5958575758`|
     ...
     section('sec1.1').
         ...
         subSection('subSec1.1.1').
             ...
             article('art1.1.1.1').
                 ...
                 paragraph('para1.1.1.1.1', permitted) :- action(A), A=='governance:amend', S == 'did:key:0x04d1j1x8f8a7a28f9a5a254c326a963a22f5a5b5d5f5e5d5c5b5a5958575758'.
                    partOf('para1.1.1.1.1', 'art1.1.1.1').
                     description('para1.1.1.1.1', 'Governance can only be amended by the identity `did:key:0x04d1j1x8f8a7a28f9a5a254c326a963a22f5a5b5d5f5e5d5c5b5a5958575758`').
```
