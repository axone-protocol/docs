...
OKP4 blockchain enables a new generation of hybrid on & off-chain applications. It is a sector-specific blockchain designed for digital assets sharing & coordination (datasets, algorithms, storage, computation...).
