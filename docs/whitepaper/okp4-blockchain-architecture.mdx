...
The [CosmWasm Token](https://github.com/CosmWasm/cw-tokens) and [CosmWasm Plus](https://github.com/CosmWasm/cw-plus) repositories are a collection of specification and contracts within [CosmWasm](https://docs.cosmwasm.com) virtual machine.
...
Each Data Space can also have its own rules (Rulebook) and its own governance mechanism that allows users to have freedom and potential to experiment without permissions. For more information please click [here](/docs/whitepaper/data-spaces#ds-governance).
