...
Data providers: are users who deposits one or more datasets on the protocol so that consumers can use it to create knowledge. They are paid for the use of their datasets.
