...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="/img/content/technical-documentation/verifiable-claims-1.webp"
    alt="Verifiable claims W3C"
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="/img/content/technical-documentation/verifiable-claims-2.webp"
    alt="Verifiable claims passport example"
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="/img/content/technical-documentation/verifiable-claims-3.webp"
    alt="Verifiable claims attached to a resource"
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="/img/content/technical-documentation/verifiable-claims-4.webp"
    alt="Verifiable presentation W3C"
