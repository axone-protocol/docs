...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="/img/content/core-concepts/describe-resource-1.webp"
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/img/content/core-concepts/transaction-explorer-2.webp" alt="Axone explorer" style={{ maxHeight: "340px" }}></img>
</div>
